...
public enum BridgeMethods {
    ...
    ADD_SIGNATURE(
            ...
            70000L,
            (BridgeMethodExecutorVoid) Bridge::addSignature//Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::addSignature, "addSignature")
    ),
    COMMIT_FEDERATION(
            CallTransaction.Function.fromSignature(
                    "commitFederation",
    ...
    GET_ULD_BLOCKCHAIN_BEST_CHAIN_HEIGHT(
            CallTransaction.Function.fromSignature(
                    "getUldBlockchainBestChainHeight",
                    new String[]{},
                    new String[]{"int"}
            ),
            19000L,
    ...
    GET_ULD_TX_HASH_PROCESSED_HEIGHT(
            CallTransaction.Function.fromSignature(
                    "getUldTxHashProcessedHeight",
                    new String[]{"string"},
                    new String[]{"int64"}
            ),
            22000L,
            (BridgeMethodExecutorTyped) Bridge::getUldTxHashProcessedHeight
    ),
    ...
    GET_STATE_FOR_ULD_RELEASE_CLIENT(
            CallTransaction.Function.fromSignature(
            ...
            4000L,
            (BridgeMethodExecutorTyped) Bridge::getStateForUldReleaseClient
    ),
    ...
    IS_ULD_TX_HASH_ALREADY_PROCESSED(
            CallTransaction.Function.fromSignature(
                    "isUldTxHashAlreadyProcessed",
                    new String[]{"string"},
                    new String[]{"bool"}
            ),
            23000L,
    ...
    RECEIVE_HEADERS(
            ...
            22000L,
            (BridgeMethodExecutorVoid) Bridge::receiveHeaders//Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::receiveHeaders, "receiveHeaders")
    ),
    REGISTER_ULD_TRANSACTION(
            CallTransaction.Function.fromSignature(
                    "registerUldTransaction",
                    new String[]{"bytes", "int", "bytes"},
                    new String[]{}
            ),
            22000L,
            (BridgeMethodExecutorVoid) Bridge::registerUldTransaction//Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::registerUldTransaction, "registerUldTransaction")
    ),
    RELEASE_ULD(
            CallTransaction.Function.fromSignature(
                    "releaseUld",
            ...
            23000L,
            (BridgeMethodExecutorVoid) Bridge::releaseUld
    ),
    ...
    UPDATE_COLLECTIONS(
            ...
            48000L,
            (BridgeMethodExecutorVoid) Bridge::updateCollections//Bridge.activeAndRetiringFederationOnly((BridgeMethodExecutorVoid) Bridge::updateCollections, "updateCollections")
    ),
    VOTE_FEE_PER_KB(
            CallTransaction.Function.fromSignature(
                    "voteFeePerKbChange",
