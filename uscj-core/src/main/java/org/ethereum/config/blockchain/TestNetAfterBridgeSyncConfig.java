...
public class TestNetAfterBridgeSyncConfig extends GenesisConfig {
    ...
    public static class TestNetConstants extends GenesisConstants {
        ...
        private static final BigInteger DIFFICULTY_BOUND_DIVISOR = BigInteger.valueOf(5); //was 10000000000000l
        ...
        private final BlockDifficulty minimumDifficulty = new BlockDifficulty(BigInteger.valueOf(896));//was 28
