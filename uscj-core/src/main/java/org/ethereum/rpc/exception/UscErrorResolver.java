 ...
 */
public class UscErrorResolver implements ErrorResolver {
    ...
    public JsonError resolveError(Throwable t, Method method, List<JsonNode> arguments) {
        ...
        if(t instanceof  UscJsonRpcRequestException) {
            error =  new JsonError(((UscJsonRpcRequestException) t).getCode(), t.getMessage(), null);
