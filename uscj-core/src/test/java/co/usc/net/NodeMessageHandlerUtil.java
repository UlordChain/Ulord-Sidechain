...
public class NodeMessageHandlerUtil {
    ...
    public static NodeMessageHandler createHandler(BlockValidationRule validationRule) {
        ...
        SyncProcessor syncProcessor = new SyncProcessor(blockchain, blockSyncService, UscMockFactory.getPeerScoringManager(), UscMockFactory.getChannelManager(), syncConfiguration, new DummyBlockValidationRule(), DIFFICULTY_CALCULATOR);
