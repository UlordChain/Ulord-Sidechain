...
public class ReleaseTransactionSetTest {
    ...
    public void sliceWithConfirmations_withLimit_none() {
        Set<UldTransaction> result = set.sliceWithConfirmations(9L, 5, Optional.of(1));
    ...
    public void sliceWithConfirmations_withLimit_singleMatch() {
        Set<UldTransaction> result = set.sliceWithConfirmations(10L, 5, Optional.of(2));
    ...
    public void sliceWithConfirmations_withLimit_multipleMatch() {
        Set<UldTransaction> result = set.sliceWithConfirmations(15L, 5, Optional.of(2));
        Assert.assertEquals(2, result.size());
        Iterator<UldTransaction> resultIterator = result.iterator();
    ...
    public void sliceWithConfirmations_noLimit_none() {
        Set<UldTransaction> result = set.sliceWithConfirmations(9L, 5, Optional.empty());
        Assert.assertEquals(0, result.size());
        Assert.assertEquals(setEntries, set.getEntries());
    }
    ...
    public void sliceWithConfirmations_noLimit_singleMatch() {
        Set<UldTransaction> result = set.sliceWithConfirmations(10L, 5, Optional.empty());
        Assert.assertEquals(1, result.size());
        setEntries.remove(new ReleaseTransactionSet.Entry(createTransaction(8, Coin.CENT.times(5)), 5L));
        Assert.assertEquals(setEntries, set.getEntries());
    }
    ...
    public void sliceWithConfirmations_noLimit_multipleMatch() {
        Set<UldTransaction> result = set.sliceWithConfirmations(15L, 5, Optional.empty());
    ...
    private UldTransaction createTransaction(int toPk, Coin value) {
        ...
        UldTransaction result = new UldTransaction(params);
