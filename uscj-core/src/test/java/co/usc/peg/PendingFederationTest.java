...
public class PendingFederationTest {
    ...
    public void publicKeysImmutable() {
        ...
        try {
            pendingFederation.getPublicKeys().add(UldECKey.fromPrivate(BigInteger.valueOf(1000)));
        } catch (Exception e) {
            exception = true;
        }
    ...
    public void buildFederation_ok_b() {
        PendingFederation otherPendingFederation = new PendingFederation(
                Arrays.asList(new UldECKey[]{
                        ...
                        UldECKey.fromPrivate(BigInteger.valueOf(600)),
                        UldECKey.fromPrivate(BigInteger.valueOf(700)),
                        UldECKey.fromPrivate(BigInteger.valueOf(800)),
                        UldECKey.fromPrivate(BigInteger.valueOf(900)),
                })
        );
