...
public class FederationTest {
    ...
    public void createFederation() {
        federation = new Federation(
                Arrays.asList(new UldECKey[]{
                        UldECKey.fromPrivate(BigInteger.valueOf(100)),
                        UldECKey.fromPrivate(BigInteger.valueOf(200)),
                        UldECKey.fromPrivate(BigInteger.valueOf(300)),
                        UldECKey.fromPrivate(BigInteger.valueOf(400)),
        ...
        sortedPublicKeys = Arrays.asList(new UldECKey[]{
                UldECKey.fromPrivate(BigInteger.valueOf(100)),
                UldECKey.fromPrivate(BigInteger.valueOf(200)),
                UldECKey.fromPrivate(BigInteger.valueOf(300)),
                UldECKey.fromPrivate(BigInteger.valueOf(400)),
    ...
    public void publicKeysImmutable() {
        ...
        try {
            federation.getPublicKeys().add(UldECKey.fromPrivate(BigInteger.valueOf(1000)));
        } catch (Exception e) {
            exception = true;
        }
    ...
    public void redeemScript() {
        ...
        PowerMockito.when(ScriptBuilder.createRedeemScript(any(int.class), any(List.class))).thenAnswer((invocationOnMock) -> {
            ...
            List<UldECKey> publicKeys = invocationOnMock.getArgumentAt(1, List.class);
    ...
    public void testEquals_differentNumberOfPublicKeys() {
        Federation otherFederation = new Federation(
                Arrays.asList(new UldECKey[]{
                        ...
                        UldECKey.fromPrivate(BigInteger.valueOf(500)),
                        UldECKey.fromPrivate(BigInteger.valueOf(600)),
                        UldECKey.fromPrivate(BigInteger.valueOf(700)),
                }),
                ZonedDateTime.parse("2017-06-10T02:30:00Z").toInstant(),
                0L,
                NetworkParameters.fromID(NetworkParameters.ID_REGTEST)
    ...
    public void testEquals_differentPublicKeys() {
        Federation otherFederation = new Federation(
                Arrays.asList(new UldECKey[]{
                        ...
                        UldECKey.fromPrivate(BigInteger.valueOf(400)),
                        UldECKey.fromPrivate(BigInteger.valueOf(500)),
                        UldECKey.fromPrivate(BigInteger.valueOf(610)),
                }),
                ZonedDateTime.parse("2017-06-10T02:30:00Z").toInstant(),
                0L,
                NetworkParameters.fromID(NetworkParameters.ID_REGTEST)
    ...
    public void getPublicKeyIndex() {
        ...
        Assert.assertNull(federation.getPublicKeyIndex(UldECKey.fromPrivate(BigInteger.valueOf(1234))));
    }
    ...
    public void hasPublicKey() {
        ...
        Assert.assertFalse(federation.hasPublicKey(UldECKey.fromPrivate(BigInteger.valueOf(1234))));
    }
