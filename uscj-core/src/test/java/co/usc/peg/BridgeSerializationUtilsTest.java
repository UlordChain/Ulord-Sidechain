...
public class BridgeSerializationUtilsTest {
    ...
    public void serializeFederation() throws Exception {
        ...
        byte[][] publicKeyBytes = new byte[][]{
                UldECKey.fromPrivate(BigInteger.valueOf(100)).getPubKey(),
                UldECKey.fromPrivate(BigInteger.valueOf(200)).getPubKey(),
                UldECKey.fromPrivate(BigInteger.valueOf(300)).getPubKey(),
                UldECKey.fromPrivate(BigInteger.valueOf(400)).getPubKey(),
                UldECKey.fromPrivate(BigInteger.valueOf(500)).getPubKey(),
                UldECKey.fromPrivate(BigInteger.valueOf(600)).getPubKey(),
        };

        Federation federation = new Federation(
            Arrays.asList(new UldECKey[]{
                    UldECKey.fromPublicOnly(publicKeyBytes[0]),
                    UldECKey.fromPublicOnly(publicKeyBytes[1]),
                    UldECKey.fromPublicOnly(publicKeyBytes[2]),
                    UldECKey.fromPublicOnly(publicKeyBytes[3]),
                    UldECKey.fromPublicOnly(publicKeyBytes[4]),
                    UldECKey.fromPublicOnly(publicKeyBytes[5]),
            }),
        ...
        federation.getPublicKeys().stream().sorted(UldECKey.PUBKEY_COMPARATOR).forEach(key -> {
            expectedBuilder.append("dd");
    ...
    public void desserializeFederation_ok() throws Exception {
        ...
        byte[][] publicKeyBytes = Arrays.asList(100, 200, 300, 400, 500, 600).stream()
            .map(k -> UldECKey.fromPrivate(BigInteger.valueOf(k)))
    ...
    public void serializePendingFederation() throws Exception {
        ...
        StringBuilder expectedBuilder = new StringBuilder();
        pendingFederation.getPublicKeys().stream().sorted(UldECKey.PUBKEY_COMPARATOR).forEach(key -> {
            expectedBuilder.append("dd");
            expectedBuilder.append(Hex.toHexString(key.getPubKey()));
        });
        byte[] expected = Hex.decode(expectedBuilder.toString());
    ...
    public void serializeLockWhitelist() throws Exception {
        ...
        byte[][] addressesBytes = new byte[][]{
                UldECKey.fromPrivate(BigInteger.valueOf(100)).getPubKeyHash(),
                UldECKey.fromPrivate(BigInteger.valueOf(200)).getPubKeyHash(),
                UldECKey.fromPrivate(BigInteger.valueOf(300)).getPubKeyHash(),
                UldECKey.fromPrivate(BigInteger.valueOf(400)).getPubKeyHash(),
                UldECKey.fromPrivate(BigInteger.valueOf(500)).getPubKeyHash(),
                UldECKey.fromPrivate(BigInteger.valueOf(600)).getPubKeyHash(),
        };
    ...
    public void serializeDeserializeOneOffLockWhitelistAndDisableBlockHeight() {
        ...
        Address address = UldECKey.fromPrivate(BigInteger.valueOf(100L)).toAddress(btcParams);
    ...
    public void serializeTransactionSet() throws Exception {
        ...
        Set<ReleaseTransactionSet.Entry> sampleEntries = new HashSet<>(Arrays.asList(
                new ReleaseTransactionSet.Entry(mockUldTransactionSerialize("ccdd"), 10L),
                new ReleaseTransactionSet.Entry(mockUldTransactionSerialize("bb"), 20L),
                new ReleaseTransactionSet.Entry(mockUldTransactionSerialize("ba"), 30L),
                new ReleaseTransactionSet.Entry(mockUldTransactionSerialize("aa"), 40L)
        ));
    ...
    public void deserializeTransactionSet_nonEmpty() throws Exception {
        ...
        UldTransaction t2 = new UldTransaction(params);
