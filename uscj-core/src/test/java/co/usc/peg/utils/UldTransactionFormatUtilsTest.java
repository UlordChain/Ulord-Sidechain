...
public class UldTransactionFormatUtilsTest {
    ...
    public void calculateUldTxHash() {
        ...
        byte[] rawUldTransaction = Hex.decode("020000000418bc858998739dbb7e7676435178dba5e71157b1537d415518d5c1fce6349018000000006a47304402204317903e40f8736858f87758e6" +
                ...
                "1288acdfdc0700");
        Assert.assertThat(UldTransactionFormatUtils.calculateUldTxHash(rawUldTransaction), is(Sha256Hash.wrap("4d63ac307e0daba3597a0d8075facb4e6cba3908a60920259b7447e28a151576")));
    }
    ...
    public void getInputsCount() {
        ...
        byte[] rawUldTransaction = Hex.decode("020000000418bc858998739dbb7e7676435178dba5e71157b1537d415518d5c1fce6349018000000006a47304402204317903e40f8736858f87758e6" +
                ...
                "010000000017a914056bce3306ec98a0247cebb654809943045d6b51877ff21500000000001976a914f7da7f0f7669bce303cfc48921bb7303e3918b" +
                "1288acdfdc0700");
        Assert.assertThat(UldTransactionFormatUtils.getInputsCount(rawUldTransaction), is(4L));
    }
}